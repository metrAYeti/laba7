...
public class DatabaseHandler {
    ...
    private void connectToDataBase() {
        try {
            ...
            Outputer.println("The connection to the database is established.");
    ...
    public void closeConnection() {
        ...
        try {
            connection.close();
            Outputer.println("The connection to the database is broken.");
            App.logger.info("Соединение с базой данных разорвано.");
        } catch (SQLException exception) {
            Outputer.printerror("An error occurred while disconnecting from the database.");
