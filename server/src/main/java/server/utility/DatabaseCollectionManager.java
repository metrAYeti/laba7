...
public class DatabaseCollectionManager {
    ...
    private final String DELETE_CHAPTER_BY_ID = "drop FROM " + DatabaseHandler.CHAPTER_TABLE +
            " WHERE " + DatabaseHandler.CHAPTER_TABLE_ID_COLUMN + " = ?";
    ...
    public SpaceMarine insertMarine(MarineRaw marineRaw, User user) throws DatabaseHandlingException {
        ...
        try {
            ...
            if (preparedInsertMarineStatement.executeUpdate() == 0){
                App.logger.info("Выполнен запрос SQLException.");
...
//            delete from space_marine where id = 6
//            delete from chapter where id = 38
