...
public class UserHandler {
    ...
    private MarineRaw generateMarineUpdate() throws IncorrectInputInScriptException {
        MarineAsker marineAsker = new MarineAsker(userScanner);
        if (fileMode()) marineAsker.setFileMode();
        String name = marineAsker.askQuestion("Do you want to change the soldier's name?") ?
                marineAsker.askName() : null;
        Coordinates coordinates = marineAsker.askQuestion("Do you want to change the soldier's coordinates?") ?
                marineAsker.askCoordinates() : null;
        double health = marineAsker.askQuestion("Do you want to change the soldier's health?") ?
                marineAsker.askHealth() : -1;
        AstartesCategory category = marineAsker.askQuestion("Do you want to change the soldier's category?") ?
                marineAsker.askCategory() : null;
        Weapon weaponType = marineAsker.askQuestion("Do you want to change the soldier's ranged weapon type?") ?
                marineAsker.askWeaponType() : null;
        MeleeWeapon meleeWeapon = marineAsker.askQuestion("Do you want to change the soldier's melee weapon?") ?
                marineAsker.askMeleeWeapon() : null;
        Chapter chapter = marineAsker.askQuestion("Do you want to change the soldier's chapter?") ?
